...
happyExpList = Happy_Data_Array.listArray (0,21) ([1504,57360,5,0,0,24064,0,94,2,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_octoparse","OctoValue","OctoValues","integer","boolean","atom","'('","')'","'\\''","%eof"]
        bit_start = st * 12
        bit_end = (st + 1) * 12
